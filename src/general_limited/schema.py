...
class State(TypedDict):
    ...
    need_grayscale: Optional[bool] = False
    need_edges: Optional[bool] = False
    gen_image_model: str = 'gemini'
    target_ratio: Optional[float] = 1.0

    # limited resource 
    limited_plan_num: int = 2
    limited_response_length: int = 1000
    limited_prompt_length: int = 1000
    limited_reflection_count: int = 1
    limited_analysis_agents: int = 3
