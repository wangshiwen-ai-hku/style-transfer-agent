...
#     # sketch_feature: str = Field(..., description="If Any, sketch seen in style image. e.g. thick/thin line, blurred, none.")
...
class State(TypedDict):
    ...
    comprehensive_style_analysis: NotRequired[ComprehensiveStyleAnalysis]
    style_transfer_analysis: NotRequired[StyleTransferAnalysis]
